...
const packages: Package[] = [
  {
    ...
    price: "$1200",
    description:
      "An excellent entry-point for 1080p gaming, balancing performance and value for popular esports and AAA titles.",
    features: [
  ...
  },
  {
    ...
    price: "$1800",
    description:
      "The sweet spot for high-refresh-rate 1440p gaming, with powerful components for a smooth and immersive experience.",
    features: [
  ...
  },
  {
    ...
    price: "$2400",
    description:
      "A top-tier rig for 4K gaming and content creation, built with flagship components for uncompromising performance.",
    features: [
    ...
    details: {
      ...
      services: [
        "Ultimate Build Service Package",
        "BIOS / Firmware Tuning",
        "24-Hour Bench Validation",
      ],
    },
  },
];
    ...
    >
      ...
      >
        ...
        <p className="mt-2 text-sm text-slate-mute">
          Note: Specific component models are selected based on market availability and performance
          benchmarks to ensure the best value at the time of your build.
        </p>
        ...
        <div className="mx-auto max-w-[1280px] px-5 md:px-8">
          <div className="text-center">
            ...
            <h2 className="mt-3 text-3xl md:text-4xl font-semibold tracking-tight">
              Pre-configured Build Packages
            </h2>
            <p className="mt-4 text-lg text-slate-mute max-w-3xl mx-auto">
              Get a guaranteed performance tier for a fixed price. We select the best components for
              your budget behind the scenes, leveraging market-value discounts to maximize
              performance.
            </p>
          </div>
          <div className="mt-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
            {packages.map((pkg) => (
              <div
                key={pkg.title}
                className={`flex flex-col relative rounded-xl border bg-background p-6 shadow-md transition-all hover:shadow-lg hover:-translate-y-1 ${pkg.isPopular ? "border-primary shadow-primary/10" : "hairline-strong"}`}
              >
                {pkg.isPopular && (
                ...
                <div className="flex-grow">
                  ...
                  <p className="mono text-[11px] uppercase tracking-[0.18em] text-slate-mute">
                    Total Parts & Labor
                  </p>
